...
export function JavaScriptBlock({ code, className, showLineNumbers, maxHeight }: JavaScriptBlockProps) {
  return (
    <CodeBlock 
      code={code} 
      language="javascript" 
...
export function TypeScriptBlock({ code, className, showLineNumbers, maxHeight }: TypeScriptBlockProps) {
  return (
    <CodeBlock 
      code={code} 
      language="typescript" 
